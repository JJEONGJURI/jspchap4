...
현재 웹어플리케이션 jspchap4 프로젝트의 모든 jsp는 하나의 application 객체를
공유합니다.</h3>
...
<% application.setAttribute("test","applicationex1.jsp application 객체에 등록한 test 속성");
	session.setAttribute("test","applicationex1.jsp 에서 session 객체에 등록한 test 속성");
%>
