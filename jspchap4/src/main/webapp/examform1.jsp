<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--/jspchap4/src/main/webapp/examform1.jsp --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%-- onsubmit : form 태그의 이벤트
				form 내부의 submit 버튼이 클릭된 경우 form 객체에 이벤트 발생 
				this : form 객체
				--%>
<%-- action 속성의 값이 없으면 현재 페이지를 재요청한다. --%>
<form action="exam1.jsp" method="post" onsubmit="return check_input(0,this)">
	<%-- type="hidden" : 파라미터값이 존재. 화면에 보여지지는 않음 --%>
	...
	<%-- this.form : button 객체가 속한 form 객체  
			this: button 객체
	 --%>
	<input type="button" value="홀수합계" onclick="return check_input(1,this.form)">
	<input type="button" value="짝수합계" onclick="return check_input(2,this.form)">
</form> <%--this 는 form객체가 아니라 this.form 이라고 해야함 --%>
